...
router.get("/profile/address/:index", authMiddleware, (req, res, next) => authController.getUserAddress(req, res, next));
router.post("/profile/address", authMiddleware, (req, res, next) => authController.addAddress(req, res, next));
router.put("/profile/address/:index", authMiddleware, (req, res, next) => authController.updateAddress(req, res, next));
router.delete("/profile/address/:index", authMiddleware, (req, res, next) => authController.deleteAddress(req, res, next));
