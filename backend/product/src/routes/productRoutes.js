...
// Variant Routes
router.post(':id/variant/:variantId', (req, res, next) => productController.addVariant(req, res, next));
...
router.put(':id/specifications/:speciId', (req, res, next) => productController.editSpecification(req, res, next));
...
// Tag Routes
router.post(':id/tags/:tagId', (req, res, next) => productController.addTag(req, res, next));
router.delete(':id/tags/:tagId', (req, res, next) => productController.deleteTag(req, res, next));
